...
e = function() {
    return (()=>{
        ...
        async function b(t, s, n, i, r, o, h) {
            ...
            const [a,l] = $();
            c[a] = l,
            t.log(e.Trace, `(${s} transport) sending data. ${m(o, h.logMessageContent)}.`);
        ...
        class _ extends d {
            ...
            send(t) {
                return t.abortSignal && t.abortSignal.aborted ? Promise.reject(new r) : t.method ? t.url ? new Promise(((s,o)=>{
                    ...
                    h.onload = ()=>{
                        t.abortSignal && (t.abortSignal.onabort = null),
                        h.status >= 200 && h.status < 300 ? s(new u(h.status,h.statusText,h.response || h.responseText)) : o(new n(h.response || h.responseText || h.statusText,h.status))
                    }
                    ,
                    h.onerror = ()=>{
            ...
            parseHandshakeResponse(t) {
                ...
                if (y(t)) {
                    ...
                    if (-1 === i)
                        throw new Error("Message is incomplete.");
                    const r = i + 1;
                    e = String.fromCharCode.apply(null, Array.prototype.slice.call(n.slice(0, r))),
                    ...
                    const r = i + 1;
                    e = n.substring(0, r),
                    s = n.length > r ? n.substring(r) : null
                }
                const n = D.parse(e)
                  , i = JSON.parse(n[0]);
                if (i.type)
        ...
        class L {
            constructor(t, s, n, i) {
                ...
                this.serverTimeoutInMilliseconds = 6e4,
                this.keepAliveIntervalInMilliseconds = 45e3,
                this.u = s,
                this.k = n,
                this.connection = t,
                this.P = i,
            ...
            et(t) {
                return this.q === R.Disconnected ? (this.u.log(e.Debug, `Call to HubConnection.stop(${t}) ignored because it is already in the disconnected state.`),
                Promise.resolve()) : this.q === R.Disconnecting ? (this.u.log(e.Debug, `Call to HttpConnection.stop(${t}) ignored because the connection is already in the disconnecting state.`),
                this.tt) : (this.q = R.Disconnecting,
                this.u.log(e.Debug, "Stopping HubConnection."),
                this.st ? (this.u.log(e.Debug, "Connection stopped during reconnect delay. Done reconnecting."),
                clearTimeout(this.st),
                this.st = void 0,
                this.nt(),
                Promise.resolve()) : (this.G(),
                this.Z(),
                this.B = t || new Error("The connection was stopped before the hub handshake could complete."),
            ...
            stream(t, ...e) {
                ...
                return o.cancelCallback = ()=>{
                    ...
                    return delete this.H[i.invocationId],
                    r.then((()=>this.ht(t)))
                }
                ,
            ...
            Y() {
                this.connection.features.inherentKeepAlive || (this.C = (new Date).getTime() + this.keepAliveIntervalInMilliseconds,
                this.Z())
            }
            K() {
                if (!(this.connection.features && this.connection.features.inherentKeepAlive || (this.dt = setTimeout((()=>this.serverTimeout()), this.serverTimeoutInMilliseconds),
                void 0 !== this.ft))) {
            ...
            _(t) {
                ...
                this.G(),
                this.Z(),
                this.q === R.Disconnecting ? this.nt(t) : this.q === R.Connected && this.P ? this.gt(t) : this.q === R.Connected && this.nt(t)
            }
            nt(t) {
                if (this.M) {
                    this.q = R.Disconnected,
                    this.M = !1,
                    g.isBrowser && document && document.removeEventListener("freeze", this.S);
                    try {
            ...
            async gt(t) {
                ...
                for (; null !== r; ) {
                    if (this.u.log(e.Information, `Reconnect attempt number ${n} will start in ${r} ms.`),
                    await new Promise((t=>{
                ...
                this.u.log(e.Information, `Reconnect retries have been exhausted after ${Date.now() - s} ms and ${n} failed attempts. Connection disconnecting.`),
                this.nt()
            }
            yt(t, s, n) {
                try {
                    ...
                    return this.u.log(e.Error, `IRetryPolicy.nextRetryDelayInMilliseconds(${t}, ${s}) threw error '${n}'.`),
                    null
                }
            }
            wt(t) {
                ...
                if (0 !== t.length) {
                    ...
                    for (const s in t)
                        t[s].subscribe({
                            ...
                            error: t=>{
                                let n;
                                n = t instanceof Error ? t.message : t && t.toString ? t.toString() : "Unknown error",
        ...
        class F {
            ...
            async connect(t, s) {
                ...
                s === O.Binary && "undefined" != typeof XMLHttpRequest && "string" != typeof (new XMLHttpRequest).responseType)
                ...
                200 !== l.statusCode ? (this.u.log(e.Error, `(LongPolling transport) Unexpected response code: ${l.statusCode}.`),
            ...
            Ht(t, e) {
                t.headers || (t.headers = {}),
                e ? t.headers[M.Authorization] = `Bearer ${e}` : t.headers[M.Authorization] && delete t.headers[M.Authorization]
            }
            async At(t, s) {
                try {
                    for (; this.Tt; ) {
                        ...
                        try {
                            ...
                            this.Tt = !1) : 200 !== r.statusCode ? (this.u.log(e.Error, `(LongPolling transport) Unexpected response code: ${r.statusCode}.`),
                            this.Dt = new n(r.statusText || "",r.statusCode),
                            this.Tt = !1) : r.content ? (this.u.log(e.Trace, `(LongPolling transport) data received. ${m(r.content, this.Pt.logMessageContent)}.`),
                            this.onreceive && this.onreceive(r.content)) : this.u.log(e.Trace, "(LongPolling transport) Poll timed out, reissuing.")
                        } catch (t) {
                            this.Tt ? t instanceof i ? this.u.log(e.Trace, "(LongPolling transport) Poll timed out, reissuing.") : (this.Dt = t,
                            this.Tt = !1) : this.u.log(e.Trace, `(LongPolling transport) Poll errored after shutdown: ${t.message}`)
                        }
                    }
                } finally {
            ...
            async stop() {
                ...
                try {
                    await this.xt,
                    this.u.log(e.Trace, `(LongPolling transport) sending DELETE request to ${this.It}.`);
                    const t = {}
                      , [s,n] = $();
                    t[s] = n;
                    const i = {
                    ...
                    if (s === O.Text) {
                        ...
                        try {
                            r.onmessage = t=>{
                                if (this.onreceive)
                                    try {
                                        this.u.log(e.Trace, `(SSE transport) data received. ${m(t.data, this.Pt.logMessageContent)}.`),
        ...
        class X {
            ...
            async connect(t, s) {
                ...
                return new Promise(((n,i)=>{
                    ...
                    ,
                    r.onmessage = t=>{
                        if (this.u.log(e.Trace, `(WebSockets transport) data received. ${m(t.data, this.Nt)}.`),
                        this.onreceive)
                            try {
                                this.onreceive(t.data)
                            } catch (t) {
            ...
            send(t) {
                return this.Wt && this.Wt.readyState === this.qt.OPEN ? (this.u.log(e.Trace, `(WebSockets transport) sending data. ${m(t, this.Nt)}.`),
                this.Wt.send(t),
                Promise.resolve()) : Promise.reject("WebSocket is not in the OPEN state")
            }
            stop() {
                return this.Wt && this.Ut(void 0),
                Promise.resolve()
            }
            Ut(t) {
                ...
                this.onclose && (!this.Ot(t) || !1 !== t.wasClean && 1e3 === t.code ? t instanceof Error ? this.onclose(t) : this.onclose() : this.onclose(new Error(`WebSocket closed with status code: ${t.code} (${t.reason || "no reason given"}).`)))
            }
            Ot(t) {
        ...
        class J {
            constructor(t, s={}) {
                ...
                this.Ft = 1,
                w.isRequired(t, "url"),
                this.u = void 0 === (n = s.logger) ? new E(e.Information) : null === n ? f.instance : void 0 !== n.log ? n : new E(n),
                ...
                g.isNode || "undefined" == typeof WebSocket || s.WebSocket ? g.isNode && !s.WebSocket && i && (s.WebSocket = i) : s.WebSocket = WebSocket,
            ...
            async start(t) {
                ...
                this.u.log(e.Debug, `Starting connection with transfer format '${O[t]}'.`),
                "Disconnected" !== this.q)
                    return Promise.reject(new Error("Cannot start an HttpConnection that is not in the 'Disconnected' state."));
                if (this.q = "Connecting",
                this.Xt = this.F(t),
                await this.Xt,
            ...
            send(t) {
                return "Connected" !== this.q ? Promise.reject(new Error("Cannot send data if the connection is not in the 'Connected' State.")) : (this.Jt || (this.Jt = new z(this.transport)),
                this.Jt.send(t))
            }
            async stop(t) {
                return "Disconnected" === this.q ? (this.u.log(e.Debug, `Call to HttpConnection.stop(${t}) ignored because the connection is already in the disconnected state.`),
                Promise.resolve()) : "Disconnecting" === this.q ? (this.u.log(e.Debug, `Call to HttpConnection.stop(${t}) ignored because the connection is already in the disconnecting state.`),
                this.tt) : (this.q = "Disconnecting",
            ...
            async F(t) {
                ...
                try {
                    ...
                    this.transport instanceof F && (this.features.inherentKeepAlive = !0),
                    "Connecting" === this.q && (this.u.log(e.Debug, "The HttpConnection connected successfully."),
                    this.q = "Connected")
                } catch (t) {
            ...
            async Qt(t) {
                ...
                try {
                    ...
                    return t instanceof n && 404 === t.statusCode && (s += " Either this is not a SignalR endpoint or there is a proxy blocking the connection."),
                    this.u.log(e.Error, s),
            ...
            async Yt(t, s, n, i) {
                ...
                for (const n of h) {
                    ...
                    if (h instanceof Error)
                        ...
                        try {
                            return await this.Kt(r, i),
                            void (this.connectionId = a.connectionId)
                        } catch (t) {
                            if (this.u.log(e.Error, `Failed to start the transport '${n.transport}': ${t}`),
                            a = void 0,
            ...
            se(t, s, n) {
                ...
                if (!function(t, e) {
                    ...
                    return this.u.log(e.Debug, `Skipping transport '${W[i]}' because it was disabled by the client.`),
                    new h(`'${W[i]}' is disabled by the client.`,i);
                if (!(t.transferFormats.map((t=>O[t])).indexOf(n) >= 0))
                    return this.u.log(e.Debug, `Skipping transport '${W[i]}' because it does not support the requested transfer format '${O[n]}'.`),
                    new Error(`'${W[i]}' does not support ${O[n]}.`);
                if (i === W.WebSockets && !this.Pt.WebSocket || i === W.ServerSentEvents && !this.Pt.EventSource)
                    return this.u.log(e.Debug, `Skipping transport '${W[i]}' because it is not supported in your environment.'`),
            ...
            Vt(t) {
                if (this.u.log(e.Debug, `HttpConnection.stopConnection(${t}) called while in state ${this.q}.`),
                this.transport = void 0,
                t = this.zt || t,
                this.zt = void 0,
                "Disconnected" !== this.q) {
            ...
            Zt(t) {
                ...
                s += "negotiate",
                s += -1 === e ? "" : t.substring(e),
                -1 === s.indexOf("negotiateVersion") && (s += -1 === e ? "?" : "&",
        ...
        class z {
            ...
            le(t) {
                if (this.ie.length && typeof this.ie[0] != typeof t)
                    throw new Error(`Expected data to be of type ${typeof this.ie} but was of type ${typeof t}`);
                this.ie.push(t),
                this.oe.resolve()
            }
            async ae() {
                for (; ; ) {
                    if (await this.oe.promise,
                    !this.re) {
        ...
        class G {
            ...
            pe(t) {
                ...
                void 0 !== t.invocationId && this.me(t.invocationId, "Invalid payload for Invocation message.")
            }
            we(t) {
                if (this.me(t.invocationId, "Invalid payload for StreamItem message."),
                void 0 === t.item)
            ...
            ge(t) {
                ...
                !t.result && t.error && this.me(t.error, "Invalid payload for Completion message."),
        ...
        class Q {
            ...
            withAutomaticReconnect(t) {
                ...
                return t ? Array.isArray(t) ? this.reconnectPolicy = new q(t) : this.reconnectPolicy = t : this.reconnectPolicy = new q,
                this
            }
            build() {
